...
# Form implementation generated from reading ui file 'qrcodeoutput.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.treeWidget_orderlist.headerItem().setText(1, _translate("Form", "出库日期"))
        self.treeWidget_orderlist.headerItem().setText(2, _translate("Form", "出库类别"))
        self.treeWidget_orderlist.headerItem().setText(3, _translate("Form", "客户"))
        self.treeWidget_orderlist.headerItem().setText(4, _translate("Form", "仓管"))
        self.treeWidget_orderlist.headerItem().setText(5, _translate("Form", "备注"))
