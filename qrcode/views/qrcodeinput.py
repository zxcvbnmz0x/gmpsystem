...
# Form implementation generated from reading ui file 'qrcodeinput.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.treeWidget_prodlist.headerItem().setText(2, _translate("Form", "批号"))
        ...
        self.treeWidget_prodlist.headerItem().setText(5, _translate("Form", "生产日期"))
