...
from equipment.views.eqrunlist import Ui_Form
...
class EqRunListModule(QWidget, Ui_Form):
    ...
    def get_run_note(self):
        ...
        for item in res:
            ...
            qtreeitem.setText(0, str(item['autoid']))
            qtreeitem.setText(
                1, str(item['runstarttime']) if type(item['runstarttime']) is
...
VALUES_TUPLE_RUN = (
    'autoid', 'runstarttime', 'runtime', 'dictid', 'dictname', 'batchno',
    'fillerid', 'fillername'
)
