...
class Checkitems(models.Model):
    ...
    putintype = models.IntegerField(db_column='PutInType', max_length=4)
...
class Clerks(models.Model):
    ...
    powers = models.CharField(db_column='powers', max_length=100, default='')
...
class Department(models.Model):
    ...
    inputcode = models.CharField(db_column='InputCode', max_length=60)  # Field name made lowercase.
    sectiontype = models.IntegerField(db_column='SectionType', default=0)  # Field name made lowercase.
    parentid = models.CharField(db_column='parentId', max_length=40)
    authority = models.CharField(db_column='authority', max_length=20)
...
class Stuffdictionary(models.Model):
    ...
    packageLv = models.IntegerField(db_column='PackageLv', max_length=4)
    unit = models.CharField(db_column='Unit', max_length=20)
    checkunit = models.CharField(db_column='CheckUnit', max_length=20)
    storage = models.CharField(db_column='Storage', max_length=40)  # Field name made lowercase.
...
class Stuffrepository(models.Model):
    ...
    deptid = models.CharField(db_column='deptid',max_length=40)
    deptname = models.CharField(db_column='deptname',max_length=30)
    nextcheckdate = models.DateField(db_column='NextCheckDate')
    ...
    mbatchno = models.CharField(db_column='mBatchNo',max_length=100)
...
class Stuffsupplyers(models.Model):
    ...
    producer = models.CharField(db_column='producer', max_length=40)
