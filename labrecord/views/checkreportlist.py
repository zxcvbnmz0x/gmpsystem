...
# Form implementation generated from reading ui file 'checkreportlist.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_3 = QtWidgets.QGridLayout(self.tab_all)
        self.gridLayout_3.setObjectName("gridLayout_3")
        self.treeWidget_labrecords = QtWidgets.QTreeWidget(self.tab_all)
        ...
        self.tabWidget_2.addTab(self.tab_all, "")
        self.tab_checking = QtWidgets.QWidget()
        self.tab_checking.setObjectName("tab_checking")
        self.tabWidget_2.addTab(self.tab_checking, "")
        self.tab_doublecheck = QtWidgets.QWidget()
        self.tab_doublecheck.setObjectName("tab_doublecheck")
        self.tabWidget_2.addTab(self.tab_doublecheck, "")
        self.tab_approval = QtWidgets.QWidget()
        self.tab_approval.setObjectName("tab_approval")
        self.tabWidget_2.addTab(self.tab_approval, "")
    ...
    def retranslateUi(self, Form):
        ...
        self.treeWidget_labrecords.headerItem().setText(10, _translate("Form", "请验人"))
        self.treeWidget_labrecords.headerItem().setText(11, _translate("Form", "请验时间"))
        ...
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_all), _translate("Form", "全部"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_checking), _translate("Form", "待检验"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_doublecheck), _translate("Form", "待审核"))
        self.tabWidget_2.setTabText(self.tabWidget_2.indexOf(self.tab_approval), _translate("Form", "待批准"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_0), _translate("Form", "入库物料"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_1), _translate("Form", "库存物料"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_2), _translate("Form", "前处理物料"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_3), _translate("Form", "半成品"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_4), _translate("Form", "成品"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _translate("Form", "退货"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("Form", "留样"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("Form", "注射用水"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_8), _translate("Form", "纯化水"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_9), _translate("Form", "环境监测"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_10), _translate("Form", "验证"))
